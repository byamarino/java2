...
form.addEventListener("submit", (e)=>{
    ...
    if((ladoA > ladoB + ladoC) || (ladoB > ladoA + ladoC) || (ladoC > ladoA + ladoB)){
        alert("Essas medidas não podem formar um trângulo. Um dos lados não pode ser maior que a soma dos outros dois.")
        form.inLadoA.focus()
        form.inLadoB.focus()
        form.inLadoC.focus()
        return
    ...
    if(ladoA == ladoB && ladoA == ladoC){
        ...
        resp1.inneerText = 'Tipo: Isóceles'
    }else{
        resp1.inneerText = 'Tipo: Escaleno'
    }
})